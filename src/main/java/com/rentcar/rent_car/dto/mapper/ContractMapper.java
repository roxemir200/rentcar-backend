...
public class ContractMapper {
    ...
    public ContractResponse toResponse(Contract contract) {
        ...
        return ContractResponse.builder()
                ...
                .carFuelType(car != null ? car.getFuelType().name() : null)
                .carTransmission(car != null ? car.getTransmission().name() : null)
                .carSeats(car != null ? car.getSeats() : null)
                .startDate(r != null ? r.getStartDate() : null)
                .endDate(r != null ? r.getEndDate() : null)
                .durationDays(r != null ? ChronoUnit.DAYS.between(r.getStartDate(), r.getEndDate()) : null)
